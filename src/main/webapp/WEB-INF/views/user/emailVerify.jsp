    ...
    <div class="w-full flex items-center justify-between py-1 px-6">
        ...
        <nav class="flex items-center space-x-8 text-xl font-semibold text-gray-800 pr-4">
            ...
            <div id="profileDropdownWrapper" class="relative hidden">
                <button onclick="toggleDropdown()" class="flex items-center space-x-2 text-xl font-bold text-gray-800">
                    <i class="fa-solid fa-user-circle text-2xl"></i><span>Hong</span>
                </button>
...
<main class="flex-grow flex items-center justify-center">
    <div class="bg-white/95 p-10 rounded-xl shadow-md w-full max-w-md text-center mt-10">
        ...
        <form class="space-y-6 text-left" id="code-form">
    ...
    <div id="errorModal" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-xl p-8 w-full max-w-sm text-center">
            ...
            <p class="text-base text-gray-700 mb-6"></p>
            <button onclick="closeModal()" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-2 rounded-full">
                닫기
            </button>
        </div>
    </div>

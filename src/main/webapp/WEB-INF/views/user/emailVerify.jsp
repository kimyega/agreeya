...
<!-- ✅ 기존 emailVerify.jsp 맨 하단에 추가 -->
<div id="alertModal"
     class="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm hidden z-50">
    <div class="bg-white rounded-2xl shadow-xl py-6 px-5 w-full max-w-xs text-center">
        <p id="alertModalMsg"
           class="text-gray-900 mb-6 text-lg font-semibold text-center leading-relaxed break-keep">
        </p>
